...
API_URL = "https://api.cloudflare.com/client/v4/accounts/B6dace8399d7b8b5caf845ee978b1a04/ai/run/@cf/black-forest-labs/flux-1-schnell"

# Substitua pela sua chave de API (se necessário)
HEADERS = {
    "Authorization": "Bearer gIivpkM4XKtau8KDgMsgGTrwqRf4JL47kuPznrgg",
